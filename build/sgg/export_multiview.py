...
from build.sgg.export_samples import (DEFAULT_SCENES, LOOSE_MAPPINGS, MIN_AREA,
                            ground_truth_relations, support_relations,
                            visible_objects)
from build.sgg.geometry import (camera_basis, intrinsics, project, relative_pose,
                          w2c_matrix)
...
def export_scene(
    ...
    from robot.geometry import _xz
    ...
    for index, (pitch, yaw_t, roll, eye) in enumerate(targets):
        ...
        from build.sgg.geometry import baseline_metrics
        views.append({
            "index": index,
