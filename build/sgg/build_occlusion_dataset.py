...
from build.sgg.geometry import (bbox_of, intrinsics_record,  # noqa: F401
                          pick_focus)
import build.sgg.occlusion_pipeline as P
from build.sgg.occlusion import MAX_OCCLUSION
from build.sgg.export_samples import support_relations
...
def build_scene(controller, scene: str, seed: int, poses: Sequence[Dict[str, Any]],
    ...
    return {"scene": scene, "seed": seed, "min_reference_px": min_px,
            ...
            "intrinsics": intrinsics_record(width, height, fov),
