...
`reports/0812.md`, `PIPELINE.md` and `nvs_pilot/README.md` cite them as the
...
| `probe_size.py` | does the target's pixel size explain the failures? | partly; drove the size bands in `build_robotic_task/build_tabletop.py` |
